 ...
 */
	function __setDefaults() {
		...
		$defaults = array(
			...
			'loginError' => __('Connexion impossible. Veuillez vérifier votre identifiant et/ou votre mot de passe.', true),
			'authError' => __('Vous n\'êtes pas autorisé à accéder à cette zone', true)
		);
